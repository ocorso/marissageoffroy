...
define( 'NOTIFIER_THEME_NAME', 'Aleph' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'aleph' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://rchour.net/notifier-aleph.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function get_latest_theme_version($interval) {
	...
	$db_cache_field = 'aleph_notifier-cache';
	$db_cache_field_last_updated = 'aleph_notifier-cache-last-updated';
