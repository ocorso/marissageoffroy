 ...
 *
 * /framework/admin/functions/functions.interface.php
...
function optionsframework_add_admin() {
	...
	$icon_path = get_template_directory_uri(). '/framework/admin/assets/images/icon.png';
    //$of_page = add_theme_page( THEMENAME, 'Theme Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
	$of_page = add_menu_page('aleph', 'aleph', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page',$icon_path,'3');
