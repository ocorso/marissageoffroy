 ...
 *
 * /framework/shortcodes/tinymce/tinymce.php
...
class add_scgen {
	...
	function add_scgen()  {
		...
		$this->path = get_template_directory_uri() . '/framework/shortcodes/tinymce/';
	...
	function add_tinymce_langs_path($plugin_array) {
		...
		$plugin_array[$this->pluginname] = get_template_directory_uri() . '/framework/shortcodes/tinymce/langs.php';
		return $plugin_array;
	}
...
function custom_colors() {
   echo '<style type="text/css">
           .mceIcon.mce_scgen{background:url(' .get_template_directory_uri() . '/framework/admin/assets/images/shortcodes.png) no-repeat !important;}
         </style>';
}
