  ...
  <div class="wrap">
    ...
    <form method="post" action="options.php">
      ...
      <table class="form-table">
        ...
        <tr valign="top"><th scope="row"><?php _e('Create navigation menus?', 'queed'); ?></th>
          <td>
            <fieldset><legend class="screen-reader-text"><span><?php _e('Create navigation menus?', 'queed'); ?></span></legend>
              <select name="queed_theme_activation_options[create_navigation_menus]" id="create_navigation_menus">
                <option selected="selected" value="yes"><?php echo _e('Yes', 'queed'); ?></option>
                <option value="no"><?php echo _e('No', 'queed'); ?></option>
              </select>
              <br />
              <small class="description"><?php printf(__('Create the header left and right menus and set their location', 'queed')); ?></small>
            </fieldset>
          </td>
        </tr>
