<?php
	...
	{  
		...
		if(version_compare($theme_data['Version'], $xml->latest) == -1) 
		{
			...
			add_theme_page( $theme_data['Name'] . 'Theme Updates', $theme_data['Name'] . '<span class="update-plugins count-1"><span class="update-count">1</span></span>', 'administrator', 'queed-updates', 'update_notifier');
		}
	}  
	...
	function update_notifier() 
	{
		...
		<div class="wrap">
			...
			<img style="float: left; margin: 0 20px 40px 0; border: 1px solid #ddd;" src="<?php echo get_bloginfo( 'template_url' ) . '/screenshot.png'; ?>" />
			<div id="instructions" style="max-width: 800px;">
				<h3>How to update the <?php echo $theme_data['Name']; ?>?</h3>
				<p><strong>Warning:</strong> You are strongly advised to make a backup of all the Theme files inside your WordPress installation folder <strong>/wp-content/themes/queed/</strong></p>
				...
				<p>2 - Extract the zip's contents, look for the extracted theme folder content and upload it via FTP to the <strong>/wp-content/themes/queed/</strong> folder. Overwrite all the older files.</p>
			...
			<div class="clear"></div>
			<h3 class="title">Queed Theme changelog</h3>
	...
	{
		$notifier_file_url = 'http://www.munto.net/themeforest/updates/queed/versions.xml';
