<div class="my_meta_control">
	...
	<p>
		...
		<input type="text" id="pixia_client_url" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>" size="5"/>
	</p>
    <p>
    	<strong>&nbsp;Project link:</strong> (Optional)<br />
		<?php $mb->the_field('ext_url'); ?>
		<input type="text" id="pixia_ext_url" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>" size="7"/>
	</p>
    <p>
    	<strong>&nbsp;Open Project Link when thumb is clicked?</strong>
		<?php 
    ...
    <p>
    	<strong>&nbsp;Disable slider and show images and videos stacked vertically?</strong>
		<?php 
    ...
    <?php
		for ($i=11;$i<26;$i++)
		{
			...
			echo 'Image/Video '.$i;
			$stringa='image_'.$i;
			$mb->the_field($stringa);
			?>
			<input type="text" id="pixia_image_<?php echo $i; ?>" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
			<input class="pirenko_upload" type="button" style="width:100px" value="Upload image" name="image_<?php echo $i; ?>">
			<?php
			echo '</p>';
		}
	?>
