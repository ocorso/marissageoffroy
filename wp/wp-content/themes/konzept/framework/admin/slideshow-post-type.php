...
function create_slideshow_post_type() {
	register_post_type( 'slideshow',
		array(
			'labels' => array(
				'name' => _x( 'Slideshow', 'post type general name', 'flowthemes' ),
				'singular_name' => __( 'Slideshow Item', 'post type singular name', 'flowthemes' ),
				'add_new' => _x('Add New Slide', 'slideshow', 'flowthemes' ),
				...
				'parent_item_colon' => '',
				'menu_name' => _x( 'Slideshow', 'flowthemes' ),
			),
			'public' => true,
			'has_archive' => false,
