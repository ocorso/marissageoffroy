            ...
            this.each(function() {
                ...
                uploader.bind('Init', function(up, res) {
                    ...
                    if (up.features.dragdrop && up.settings.dragdrop) {
                        ...
                        //$('#' + id + '_filelist').append('<li class="plupload_droptext">' + _("Drop files here") + '</li>');
						
						// Extension by Flow
						$('#' + id + '_filelist').append('<li class="plupload_droptext"><div class="plupload_droptext_inner">' + _("Drop files here") + '<div class="flow_plupload_medialibrary">' + '(or <span class="flow_plupload_medialibrary_link">open Media Library</span>)' + '</div></div></li>');
						$('.flow_plupload_medialibrary_link').on('click.ss_dragdrop_uploader', function(){
							...
							wp.media.editor.send.attachment = function(props, attachment){
								createSSTile(attachment.url, attachment.alt);
