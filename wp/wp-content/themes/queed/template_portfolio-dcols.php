...
<?php get_header(); ?>
    ...
    <div id="content" class="<?php echo CONTAINER_CLASSES; ?>">
        ...
        if ($my_query->have_posts()) : 
						$ins=0;
						echo "<ul class=\"filterable-grid grid_db cf\">";
							while ($my_query->have_posts()) : $my_query->the_post(); 
						
							?>
						<li id="post-<?php the_ID(); ?>" class="portfolio_entry_li_db cf" data-type="<?php $skills_links="";
    ...
    <?php echo $skills_yo; ?>" data-id="id-<?php echo $ins; ?>">
							...
							if (has_post_thumbnail( $post->ID ) ):
								...
								<div class="grid_image_wrapper_db">
                                	<div class="grid_single_title_db" id="grid_title-<?php the_ID(); ?>">
								...
								?>
                                	<div class="grid_colored_block_db">
									</div>
                                    ...
                                    if (has_post_thumbnail( $post->ID ) )
                                    {
										...
										{
											$vt_image = vt_resize( '', $image[0] , 468, 360, true );
											?>
											<img src="<?php echo $vt_image['url']; ?>" id="home_fader-<?php the_ID(); ?>" int_id="<?php the_ID(); ?>" class="custom-img custom-img_db grid_image" alt="" />
											<?php
										}
										else
										{
											?>
											<img src="<?php bloginfo('template_directory'); ?>/inc/plugins/timthumb/timthumb.php?src=<?php echo $image[0]; ?>&w=468&h=360&f=2" class="custom-img custom-img_db grid_image<?php if ($queed_frontend_options['blog_bw']=="yes") echo " desaturated_image"; ?>" alt="" />
											<?php
										}
                                    }
                                    ?>
