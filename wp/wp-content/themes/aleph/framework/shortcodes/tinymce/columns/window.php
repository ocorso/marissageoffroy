 ...
 *
 * /framework/shortcodes/tinymce/columns/window.php
...
<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/framework/shortcodes/tinymce/columns/tinymce.js?1.3"></script>
<style type="text/css">
