<?php
 /*
Template Name: Page-contact-sidebar-fullwidth
*/ ?>
 <?php get_header();
$status = "";
                            ...
                            <div id="contact_form">
                                ...
                                <div class="contact_form_right">
                                    <form action="<?php the_permalink(); ?>" method="post" id="contactform">
                                        ...
                                        <label for="cf_author"><small><?php echo get_option('ff_contact_name'); ?></small></label></p>

                                        <p><input type="text" name="cf_email" id="cf_email" value="" tabindex="2" aria-required='true' />
                                        <label for="cf_email"><small><?php echo get_option('ff_contact_email'); ?></small></label></p>

                                        <p><input type="text" name="cf_url" id="cf_url" value="" tabindex="3" />
                                        <label for="cf_url"><small><?php echo get_option('ff_contact_website'); ?></small></label></p>
