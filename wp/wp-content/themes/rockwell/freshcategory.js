...
////////////////////////////////////////////////////////////////////////////////
   ...
   $('#nav-tab-single-blog').click(function(){
    ...
    //alert('d');
      ...
      //  alert('s');
        ...
        $('#single-options-additional').find('input').each(function(){
          ...
          /*
            var single_nav_tab = new_radio_single.parent().parent().parent().parent().attr('title');
            $('#'+single_nav_tab).css('display','block');
            $('#'+single_nav_tab).find('ul').css('display','none');
            */
        //    new_radio_cat.css('display','none');
        ///}
        // switch post meta:
    ...
    /*
        ...
        // cat switcher
        var new_radio_cat = $('#category-options').find('radio['+$(this).find('.cat_template').attr('value')+']');
        new_radio_cat.attr('checked',true);
        // switch post meta:
        $('#post-meta').find('input').attr('checked',false);
        if( $(this).find('.single_author').attr('value') == 'true' )  $('#post_meta_author').attr('checked', 'true');
    ...
    $('#cat-list').find('.cat_apply').click(function(){
      //  alert('d');
    });
/*    $('#nav-tab-blog').click(function(){
        $('#category-blog').css('display','block');
    ...
    $('#cat-list li').click(function(){
        ...
        var actual_template = $(this).find('input').attr('value');
        //alert (actual_template);
        //var new_imput = $('#category-options').find('radio[value=blog-cat-1]');
        var actual_template_input = $('#category-options').find('input[value="'+actual_template+'"]');
        //alert(actual_template_input.attr('value'));
        $('#category-options').animate({opacity:0.2},150, function(){
            if(actual_template_input.length != 0)
            {

                //$('.templates_wrapper').css('display','none');
                actual_template_input.attr('checked','checked');
                $('#category-portfolio').css('display','none');
                $('#category-blog').css('display','none');
                actual_template_input.parent().parent().parent().parent().parent().find('.templates_wrapper').css('display','none');
                actual_template_input.parent().parent().parent().parent().css('display','block');
                actual_template_input.parent().parent().parent().parent().parent().css('display','block');
                if(actual_template_input.parent().parent().parent().parent().parent().attr('id') == 'category-blog')
                {
                    $('#nav-tab-blog').addClass('nav-tab-active');
                    $('#nav-tab-portfolio').removeClass('nav-tab-active');
           ...
           $('#category-options').animate({opacity:1},150);
        });
        $('#cat-list li').removeClass('active');
        $(this).addClass('active');
    });
    $('#category-options').find('input').click(function() {
        $('#cat-list').find('.active').find('input').attr('value', $(this).attr('value'));
    });

   // alert('marve ty ppiiicoo');                           */
});
