<?php
  ...
  $where_sql = '';
  if(!IS_FINAL) $where_sql = ' WHERE id IN (5,6,7)';
...
<div id="slider-2" >
   ...
   <?php if( get_option('ff_slider2_title') == 'true') {?>  <div class="info_line"><a href="<?php echo $r2r['link_url']; ?>"><span class="slide_name"><?php echo $r2r['alt']; ?></span></a></div>
   <ul class="slider_nav">
   <?php
    ...
    <div id="slider-feed">
        <?php while ($row = mysql_fetch_array($result)) { ?>
            <div class="slide">
                ...
                <div class="title"><span class="slide_name"><?php echo $row['alt']; ?></span></div>
